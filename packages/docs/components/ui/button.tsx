...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-lg text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-black text-gray-50 shadow-sm hover:bg-gray-800",
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm hover:bg-gray-200",
        outline:
          "border border-gray-200 bg-white shadow-sm hover:bg-gray-100 hover:border-gray-300",
        secondary:
          "bg-secondary text-secondary-foreground shadow-sm hover:bg-secondary/80",
        ghost: "hover:bg-gray-100 hover:border-gray-300",
